				...
				.data
					...
					; messeges
					msg_game_over db 'GAME OVER!: ( You’ve hit a dead end. Try again! ) 	PRESS Esc TO EXIT      ' ,0Ah , 0Dh , '$'
					msg_game_over2 db '                          PRESS SPACE TO START AGAIN',0Ah , 0Dh , '$'
					msg_game_win db 'YOU HAVE WON THE GAME!!:)  PRESS ANY KEY TO EXIT' ,0Ah , 0Dh , '$'
					msg_start_game db 'WELCOME TO SNAKE GAME! PRESS THE Esc KEY TO EXIT THE GAME. enjoy:)',0Ah , 0Dh , '$'
